...
class CosyVoiceServiceImpl(cosyvoice_pb2_grpc.CosyVoiceServicer):
    def __init__(self, args):
        self.cosyvoice = CosyVoice2(args.model_dir, load_jit=False, load_trt=True, fp16=False)
    ...
    def Inference(self, request, context):
        if request.HasField('sft_request'):
            ...
            start_inference_instruct = time.time()
            ...
            logging.info(f"inference instruct {end_inference_instruct - start_inference_instruct}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir',
                        type=str,
                        default='/data/codes/CosyVoice/pretrained_models/CosyVoice2-0.5B',
                        help='local path or modelscope repo id')
    parser.add_argument('--stream',
                        type=bool,
                        default=True,
                        help='support streaming TTS')
