...
docker run \
    ...
    (GRPC_SERVER=localhost:50001 python -m uvicorn app:app --host 0.0.0.0 --port 8081 &) && \
    python3 server_stream.py --port 50001 --model_dir /opt/CosyVoice/pretrained_models/CosyVoice-300M-Instruct --stream True
    "
